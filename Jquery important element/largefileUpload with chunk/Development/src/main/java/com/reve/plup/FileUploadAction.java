...
public class FileUploadAction {
    ...
    public static final String FileDir = Constant.FILE_UPLOAD_DIR;
...
//    public void doxxPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {//for servlet code
...
//    }
    ...
    String handleFileUpload(
        ...
        System.out.println("-->"+name+"-->"+chunk+"-->"+chunks);
        //no chunk
        if(chunks ==-1 && chunk == -1) {
            try {
            ...
            Path source = Paths.get(Constant.TEMP_UPLOAD_DIR,name);
            //create temp file
            //first call
            if(chunk==0 && chunks>=0) {
                ...
                {
//                    Files.write(source, file.getBytes(), StandardOpenOption.APPEND);
                    Path target = Paths.get(Constant.FILE_UPLOAD_DIR,name);
